export default function EmployerCTA() {
  return (
    <section className="mt-16 rounded-xl bg-teal-600 px-6 py-10 sm:px-10">
      <div className="flex flex-col justify-between gap-6 md:flex-row md:items-center">
        ...
        <button className="shrink-0 rounded-lg bg-white px-5 py-3 text-sm font-semibold text-teal-700 transition hover:bg-teal-50">
          Pasang lowongan
        </button>
      </div>
    </section>
